  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{ height: silhouetteHeight, filter: "drop-shadow(0 4px 24px rgba(46,134,171,0.15))" }}
      >
        <svg
          viewBox="0 0 220 440"
        ...
        >
          ...
          {/* === Base white silhouette (decorative parts) === */}
          {/* Head */}
          <ellipse cx="110" cy="38" rx="20" ry="25" fill={decoFill} stroke={decoStroke} strokeWidth={decoStrokeWidth} />
          {/* Neck */}
          <rect x="102" y="58" width="16" height="18" rx="4" fill={decoFill} stroke={decoStroke} strokeWidth={decoStrokeWidth} />
          {/* Hands */}
          <ellipse cx="40" cy="225" rx="8" ry="10" fill={decoFill} stroke={decoStroke} strokeWidth="1" />
          <ellipse cx="180" cy="225" rx="8" ry="10" fill={decoFill} stroke={decoStroke} strokeWidth="1" />
          {/* Feet */}
          <path d="M68 390 Q66 400 64 406 Q62 412 66 414 L90 414 Q94 412 94 406 Q94 400 92 390 Z" fill={decoFill} stroke={decoStroke} strokeWidth="1" />
          <path d="M128 390 Q126 400 126 406 Q126 412 130 414 L154 414 Q158 412 156 406 Q156 400 152 390 Z" fill={decoFill} stroke={decoStroke} strokeWidth="1" />

          {/* === Base body parts (white silhouette layer) === */}
          <path d="M68 78 Q56 84 48 100 Q42 116 38 140 Q34 165 34 190 Q33 205 36 215 L52 215 Q54 205 54 190 Q54 165 58 140 Q62 116 66 100 Q70 90 78 82 Z" fill={decoFill} stroke={decoStroke} strokeWidth="1" />
          <path d="M152 78 Q164 84 172 100 Q178 116 182 140 Q186 165 186 190 Q187 205 184 215 L168 215 Q166 205 166 190 Q166 165 162 140 Q158 116 154 100 Q150 90 142 82 Z" fill={decoFill} stroke={decoStroke} strokeWidth="1" />
          <path d="M78 76 Q90 74 110 74 Q130 74 142 76 Q150 80 154 90 Q158 100 158 110 Q156 130 152 145 Q148 158 142 170 Q136 178 130 180 L90 180 Q84 178 78 170 Q72 158 68 145 Q64 130 62 110 Q62 100 66 90 Q70 80 78 76 Z" fill={decoFill} stroke={decoStroke} strokeWidth="1" />
          <path d="M90 180 Q84 182 78 186 Q70 192 66 200 Q62 208 60 216 L104 216 L104 200 Q102 192 98 186 Q96 182 90 180 Z" fill={decoFill} stroke={decoStroke} strokeWidth="1" />
          <path d="M130 180 Q136 182 142 186 Q150 192 154 200 Q158 208 160 216 L116 216 L116 200 Q118 192 122 186 Q124 182 130 180 Z" fill={decoFill} stroke={decoStroke} strokeWidth="1" />
          <path d="M60 216 L104 216 L100 310 Q98 316 94 318 L70 318 Q66 316 64 310 Z" fill={decoFill} stroke={decoStroke} strokeWidth="1" />
          <path d="M116 216 L160 216 L156 310 Q154 316 150 318 L126 318 Q122 316 120 310 Z" fill={decoFill} stroke={decoStroke} strokeWidth="1" />
          <path d="M70 318 L94 318 Q96 340 96 355 Q96 370 94 380 Q92 388 90 390 L70 390 Q68 388 66 380 Q64 370 64 355 Q64 340 66 318 Z" fill={decoFill} stroke={decoStroke} strokeWidth="1" />
          <path d="M126 318 L150 318 Q152 340 156 355 Q156 370 154 380 Q152 388 150 390 L130 390 Q128 388 126 380 Q124 370 124 355 Q124 340 126 318 Z" fill={decoFill} stroke={decoStroke} strokeWidth="1" />

          {/* === Hydration aura ribbon (optional) === */}
          {showHydrationAura && (
            <path
          ...
          {/* === Heat overlay layer (interactive, with glow) === */}
          <g>
            {/* Braço esq */}
            <path d="M68 78 Q56 84 48 100 Q42 116 38 140 Q34 165 34 190 Q33 205 36 215 L52 215 Q54 205 54 190 Q54 165 58 140 Q62 116 66 100 Q70 90 78 82 Z"
              ...
              filter={areas.braco_esq > 0 ? "url(#heatGlow)" : undefined}
              onClick={() => toggleArea("braco_esq")}
              className={areaClass("braco_esq")}
            />
            {/* Braço dir */}
            <path d="M152 78 Q164 84 172 100 Q178 116 182 140 Q186 165 186 190 Q187 205 184 215 L168 215 Q166 205 166 190 Q166 165 162 140 Q158 116 154 100 Q150 90 142 82 Z"
              ...
              stroke="transparent" strokeWidth="0"
              filter={areas.braco_dir > 0 ? "url(#heatGlow)" : undefined}
              onClick={() => toggleArea("braco_dir")}
              className={areaClass("braco_dir")}
            />
            {/* Abdômen */}
            <path d="M78 76 Q90 74 110 74 Q130 74 142 76 Q150 80 154 90 Q158 100 158 110 Q156 130 152 145 Q148 158 142 170 Q136 178 130 180 L90 180 Q84 178 78 170 Q72 158 68 145 Q64 130 62 110 Q62 100 66 90 Q70 80 78 76 Z"
              ...
              stroke="transparent" strokeWidth="0"
              filter={areas.abdomen > 0 ? "url(#heatGlow)" : undefined}
              onClick={() => toggleArea("abdomen")}
              className={areaClass("abdomen")}
            />
            {/* Quadril esq */}
            <path d="M90 180 Q84 182 78 186 Q70 192 66 200 Q62 208 60 216 L104 216 L104 200 Q102 192 98 186 Q96 182 90 180 Z"
              ...
              stroke="transparent" strokeWidth="0"
              filter={areas.quadril_esq > 0 ? "url(#heatGlow)" : undefined}
              onClick={() => toggleArea("quadril_esq")}
              className={areaClass("quadril_esq")}
            />
            {/* Quadril dir */}
            ...
            <path d="M70 318 L94 318 Q96 340 96 355 Q96 370 94 380 Q92 388 90 390 L70 390 Q68 388 66 380 Q64 370 64 355 Q64 340 66 318 Z"
              ...
              stroke="transparent" strokeWidth="0"
              filter={areas.panturrilha_esq > 0 ? "url(#heatGlow)" : undefined}
              onClick={() => toggleArea("panturrilha_esq")}
              className={areaClass("panturrilha_esq")}
            />
            {/* Panturrilha dir */}
            <path d="M126 318 L150 318 Q152 340 156 355 Q156 370 154 380 Q152 388 150 390 L130 390 Q128 388 126 380 Q124 370 124 355 Q124 340 126 318 Z"
              ...
              stroke="transparent" strokeWidth="0"
              filter={areas.panturrilha_dir > 0 ? "url(#heatGlow)" : undefined}
              onClick={() => toggleArea("panturrilha_dir")}
              className={areaClass("panturrilha_dir")}
            />
          </g>
        </svg>
      </motion.div>
